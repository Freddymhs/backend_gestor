// api/schema.ts
import { enumType, inputObjectType, makeSchema, mutationType, objectType, queryType, subscriptionType, unionType } from 'nexus';
    ...
    t.list.field('users', {
      ...
      resolve: () => {
        return [
          ...
          { id: 2, name: 'Alice', email: 'alice@example.com', role: 'WORKER' },
        ];
      },
    });
